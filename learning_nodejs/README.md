...
Ce token sera utilisé dans l'entête d'autorisation et sera vérifié à l'aide d'un *middleware* que nous avons créé :
```jsx 
const jwt = require('jsonwebtoken')
const privateKey = require('../auth/private_key')

module.exports = (req, res, next) => {
    const authorizationHeader = req.headers.authorization   //Récupération de l'entête (là où est stocké le token)
...
Ce *middleware* permet donc de vérifier l'authentification de nos utilisateurs afin de pouvoir sécuriser notre API REST 